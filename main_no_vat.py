...
num_labeled = 1000
num_valid = 1000
num_iter_per_epoch = int(50000/2 / (batch_size))
eval_freq = 2
lr = 0.001
cuda_device = "2"
...
test_data = []
test_target = []
np_index_data = np.random.choice(int(50000/batch_size), int(50000/batch_size/2), replace=False)
print(len(np_index_data))
index =0
